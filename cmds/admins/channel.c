...
string GetHelp(string blah) {
    return "Syntax: <channel [add|remove] [player] [channel]>\n"
           "        <channel [player]>\n\n"
           "Used to restrict a player from using a line, or to allow "
           "them back onto that line. Passed with just the player name, "
           "this command will return a list of the player's currently "
           "restricted lines.";
}
