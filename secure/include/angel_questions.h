string *Questions = ({
  ...
  "Name two of the Adventurers listed on the sign outside "
    "of Stryke's lair.",
  "Name the mountain ranges of Kailie.",
  "Name at least six religions.",
  "If one wanted to buy a 'rat-on-a-stick' where would "
    "they have to go?",
  ...
  "What religion would you be interested in helping with and "
    "why?",
  "What is your least favorite area on Kailie and why?",
  "Please explain your role-playing influence in regards "
    "to religion on Kailie.",
  "Please explain your role-playing influence in regards "
    "to your town on Kailie.",
  "Please explain your role-playing influence in regards "
    "to race on Kailie.",
