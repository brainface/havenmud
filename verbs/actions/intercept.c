...
static void create() {
  ...
  SetVerb("intercept");
  SetRules("LIV", "");
  SetHelp("A swordsman, in a moment of bravery, can interpose himself between "
    "a foe and an ally. Few bodyguards are willing to perform such a rash act "
    "without a shield, of course.");
  SetStaminaCost(100);
