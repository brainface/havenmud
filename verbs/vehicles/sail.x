...
mixed do_sail_str(string str) {
  ...
  // mahkefel 9/2014: added pro = to your navigation skill,
  // when fighting enemy ships. Note that it only adds once.
  // (essentially superior skill in navigation helps you escape.)
