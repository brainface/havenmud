...
static void create() {
  ...
  SetDayLong(
     ...
     "and west.  Several of the trees here have scorch marks on them, as if "
  ...
  SetExits( ([
     "north" : VAAS_ROOM + "forest3",
     "west" : VAAS_ROOM + "forest5",
     "south" : ESTERGRYM_VIRTUAL "grymxoria_road/36,0",
     ]) );
}
