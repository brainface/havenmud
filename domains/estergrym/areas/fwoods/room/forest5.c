...
static void create() {
  ...
  SetDayLong(
     ...
     "Though the underbrush is heavy, a faint path can be seen leading east "
     "and northwest. Several of the trees here have scorch marks on them, as "
     "if there had been a recent fire."
     );
  SetNightLong(
     ...
     "Though the underbrush is heavy, a faint path can be seen leading east "
     "and northwest. Several of the trees here have scorch marks on them, as if "
  ...
  SetExits( ([
     "northwest" : VAAS_ROOM + "forest6",
     "east" : VAAS_ROOM + "forest4",
     ]) );
}