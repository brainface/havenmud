...
static void create() {
  ...
  SetLong(
    "The circle of stone extends in a circle to the south and east. "
    "In the center of the circle, to the southeast, lies a huge stone altar. "
    "The soil around "
  ...
  SetExits( ([
    ...
    "east"  : TULU_ROOM "hill06",
    "south" : TULU_ROOM "hill02",
    ]) );
  SetSmell("The rotting meat smell seems to come from the southeast.");
  SetInventory( ([
