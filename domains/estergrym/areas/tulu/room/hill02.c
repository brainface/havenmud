...
static void create() {
  ...
  SetLong(
    ...
    "In the center of the circle, to the east, lies a huge stone altar. "
    "The soil around "
  ...
  SetExits( ([
    "south" : TULU_ROOM "hill08",
    "east"  : TULU_ROOM "hill03",
    "north" : TULU_ROOM "hill07",
    ]) );
  SetSmell("The rotting meat smell seems to come from the east.");    
  SetInventory( ([
