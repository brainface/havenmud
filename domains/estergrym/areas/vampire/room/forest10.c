...
static void create() {
  ...
  SetLong(
     "The path winds to the northwest and northeast, the trees "
  ...
  SetItems( ([
     ({"path", "pathway", "trail"}) : "Surrounded by dense forest the small "
       "path wends its way to the northwest and northeast from here. Littered "
  ...
  SetExits( ([
     "northeast" : VAMP_ROOM + "forest4",
     "northwest" : VAMP_ROOM + "forest11",
     ]) );
