...
static void create() {
  ...
  SetLong(
     "The path continues to the northeast, northwest and south, the trees "
  ...
  SetListen( ([
     "default" : "The only sound is a faint rustling of dead leaves.",
     ]) );
  SetItems( ([
     ({"path", "pathway", "trail"}) : "Surrounded by dense forest the small "
       "path wends its way to the northeast, northwest and south from here. "
  ...
  SetExits( ([
     "northeast" : VAMP_ROOM + "forest9",
     "south" : VAMP_ROOM + "forest11",
     "northwest" : VAMP_ROOM + "forest13",
     ]) );
