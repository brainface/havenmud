...
static void create() {
 ...
 "A waterfall across the water sparkles with radiance as it sprays a "
  ...
  SetNightLong("The moon light shines off the water with a gentle rippling "
     ...
     "soothing feel to the area, brining calm and happyness. "
  ...
  SetExits( ([
     "southwest" : LAKE_ROOM + "/lake3",
     "north" : LAKE_ROOM + "/lake5",
     ]) );
  SetInventory( ([
     LAKE_OBJ + "/smallrock" : 1,
     ]) );
  SetSpeed(5);
  SetFish( ([
          LAKE_OBJ + "/fish_1" : 100,
