...
static void create() {
  ...
  SetLong(
    ...
    "continues to the east and west. To the north is a squat "
    "stone building with a sign hung over the door proclaiming "
    "it the 'Grymxoria bank.' To the west looms the Grymxoria arena."
  );
  SetItems( ([
