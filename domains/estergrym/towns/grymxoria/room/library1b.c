...
static void create() {
  ...
  SetLong(
    ...
    "There is a cozy fire burning in a fireplace, and there are several "
    "comfortable couches scattered about the room. On one wall "
    "is the mage discussion board."
  );
  SetSmell( ([
  ...
  SetItems( ([
    ({ "fire", "fireplace" }) : "A cozy fire burning in a stone fireplace.",
