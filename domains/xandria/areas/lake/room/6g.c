...
static void create() {
  ...
  SetLong(
    ...
    "to the west, and to the north runs the River Itro. Eastward "
    "stands the desert, and nearer, some buildings. The way south "
    "is barred by impassable rapids."
  );
  SetItems( ([
    ({ "water", "waters", "lake" }) :
    ...
    ({ "rapids" }) :
    "The rapids to the south are impassable.",
  ]) );
  SetItemAdjectives( ([
  "waters" : ({ "dark" }),
  "bottom" : ({ "silt-covered" }),
  ...
  SetListen("The waves crash near the rapids.");
