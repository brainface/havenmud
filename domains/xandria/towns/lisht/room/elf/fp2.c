...
static void create() {
  ...
  SetClimate("arid");
  SetExits( ([
    "north" : LISHT_ROOM "elf/fp1",
    "south" : LISHT_ROOM "elf/fp3",
    "west"  : LISHT_ROOM "elf/fp6",
    "east"  : XANDRIA_VIRTUAL "river/-1,-3",
    ]) );
  ...
  SetLong(
    ...
    "lands. The plain continues to the north, south, and west from here."
    );
