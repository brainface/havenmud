...
static void create() {
  room::create();
  SetShort("sixth floor stairs along the north wall");
  SetLong("The stairs continue on up to a seventh floor.  The stairs "
  ...
  SetExits( ([ "southwest" : V_ROOM + "fl06w",
	       "southeast" : V_ROOM + "fl06e" ]) );
}