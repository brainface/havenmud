...
inherit LIB_ROOM;
 ...
 static void create() {
  ...
  SetClimate("arctic");
   SetItems( ([
        "woods" : (:GetLong:),
      ({"tree","trees"}) : "These trees are exceptionally big.  They are dead with "
       ...
       "They are scattered aaround and are pretty much dead.",
  ...
  SetExits( ([
      "west" : L_ROOM + "outside2.c",
      "east" : L_ROOM + "outside10.c",
   ]) );  
   SetInventory( ([
   L_NPC + "protector" : 1,
   L_NPC + "defender" : 1,
