...
static void create() {
  ...
  SetClimate("arctic");
  SetExits( ([
    "north" : INNERSEA_VIRTUAL "ocean/-155,112",
    "northwest" : INNERSEA_VIRTUAL "ocean/-156,112",
    "south" : K_ROOM "/road3",
    "west"  : INNERSEA_VIRTUAL "ocean/-156,111",
  ...
  SetInventory( ([
    //K_OBJ "/k_longship" : 2,
    //K_NPC "/godenviking" : 1,
    INNERSEA_ENCOUNTERS "viking/godenviking" : 1,
    INNERSEA_ENCOUNTERS "viking/longship" : 2,
    INNERSEA_ENCOUNTERS "viking/smallboarder" : 1,
    ]) );
}
