...
int PreExit() {
   message("system","The stairs end with a door around the next turn, "
           "which is, unfortunately, locked, sending you back down "
           "around the next curve.",this_player());
   return 1;
}
