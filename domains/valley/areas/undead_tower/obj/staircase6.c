...
static void create() {
    ...
    SetLong("This is the middle section of a magnificent staircase. It "
      ...
      "There is a door above and below on the staircase and there is a "
      "doorway here. It is a real long drop to the bottom floor.");
    SetAdjectives(({"magnificent","old","stone","carved"}));
    SetClimb(TROOM + "/stair7",CLIMB_UP);
    SetClimb(TROOM + "/stair5",CLIMB_DOWN);
