...
SetItems( ([
     ...
     ({ "bushes", "bush", "small bushes" }) : 
                  ...
                  "perfectly in height and shape. They run right down the side "
                  "of the path. Not one of them seems to be out of line. ",
     ({ "leaf", "leaves" }) : 
                  "The leaves on the trees are all glowing green. They seem to "
                  "luminate the path. ",
  ]) );
...
SetExits( ([
    "west" : SF_ROOM "forest15",
    "east" : SF_ROOM "forest17",  
  ]) ) ;
}
