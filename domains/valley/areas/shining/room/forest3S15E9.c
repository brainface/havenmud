/* Shinning Forest Room: forest3S15E9
 * Created by Ohtar
 */
#include <lib.h>
#include "../sf.h"
...
static void create() {
  ...
  SetLong(
    ...
    "continues east into the forest. The only other direction of "
    "travel would be back west." );
SetItems( ([
...
SetExits( ([
    "west" : SF_ROOM "forest3S15E8",
    "east" : SF_ROOM "forest3S15E10",
  ]) ) ;
}
