...
static void create() {
  ...
  SetLong(
    ...
    "smallest amount of sunlight. However, strangely enough it seems "
    "to be rather bright here. The path continues north along the edge "
    "of the forest. The only other direction of travel would be back "
    "south towards the opening of the shining forest. " );
SetItems( ([
...
SetExits( ([
    "north" : SF_ROOM "forest3N14",
    "south" : SF_ROOM "forest3N12",  
  ]) ) ;
}
