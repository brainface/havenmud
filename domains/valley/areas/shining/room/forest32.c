...
static void create() {
  ...
  SetLong(
    ...
    "Every stone seems to be lined up perfectly with the "
    "next. Several bushes run along each side of the path. "
    "Oddly, not one seems to be out of place. The very "
    "large trees here appear to be hundreds of years old. "
    "They stand so tall into the sky they block out even the "
    "smallest amount of sunlight. However, strangely enough "
    "it seems to be rather bright here. The path continues "
    "east along the stream further into the forest. The only "
    "other direction of travel would be back west towards "
...
SetItems( ([
     ...
     ({ "beautiful forest", "shining forset", "trees" , "tree", "large trees", "large tree" }) : 
                  ...
                  "brown in color and appear to be very solid. Several of "
                  "the trees have a small hole in them about fifteen feet "
                  "up them. Many of the the leaves on the trees are a "
                  "glowing green.", 
     ({ "sky" }) : 
...
SetExits( ([
    "west" : SF_ROOM "forest31",
    "east" : SF_ROOM "forest33",  
  ]) ) ;
}
