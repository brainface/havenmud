...
static void create() {
  ...
  SetShort("a dead end in the forest");
  SetLong(
    ...
    "strangely enough it seems to be rather bright here. The bushes "
    "seem to block the path here. The only exit would seem to be "
...
SetItems( ([
     ...
     ({ "beautiful forest", "shining forset", "trees" , "tree",
        "large trees", "large tree" }) : 
                  ...
                  "sprawl across the sky covering every inch. They "
                  "are brown in color and appear to be very solid. "
                  "Several of the trees have a small hole in them "
                  "about fifteen feet up them. Many of the the leaves "
                  "on the trees are a glowing green.", 
     ({ "sky" }) : 
     ...
     ({ "bushes", "bush", "small bushes" }) : 
                  ...
                  "down the side of the path and then form a wall at "
                  "at the end of it. Not one of them seems to be out "
                  "of line. ",
     ({ "leaf", "leaves" }) : 
...
SetSmell( ([ "default" : "The smell of sweet berries and fruits "
                         "fill the air.", 
    ]) );
SetInventory( ([
    SF_OBJ + "stream" : 1,
