...
static void create() {
    ...
    SetLong("This is a small hut made of stone and wood. In the center "+
      ...
      "as a dwelling for a small group of people. There is a pile "+
	...
	"The grasses and pelts of various animals are piled into a large "+
	"heap which appears to be a bed. The pile looks as if it "+
	"is used frequently.",
