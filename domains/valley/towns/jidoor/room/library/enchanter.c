...
static void create() {
   ...
   SetItems( ([
      ...
      ({"staircase","stairs"}) : "The staircase is literally huge and "
          ...
          //"evoker's section.",
          "radiance. It leads down into the evoker's section, but the way "
          "further up seems to... also lead back down, judging by your "
          "upside down face peering back at you.",
       ({"face"}) : "It grins and frowns as you do, clearly a magical "
         "reflection.",
