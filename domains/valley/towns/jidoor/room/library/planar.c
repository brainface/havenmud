...
static void create() {
   ...
   SetAmbientLight(60);
   SetClimate("indoors");
   SetShort("the Planar Magic Section of the Great Library of Jidoor");
   SetLong("This section of the tower is obviously for the study of the art "
           "of planar magic. A large marble staircase leads up into the "
           "tower and down to the enchanter's section of the library. "
   ...
   SetItems( ([
      ...
      ({"book","books"}) : "The books lining the shelves are all "
          "concerned with the study of planar magic the most dangerous"
          "of the magical arts.",
      ({"chairs", "chair","table","tables","couches","couch"}) : "The "
          ...
          "books on the art of planar magic.",
   ...
   SetExits( ([ 
      "down" : JID_ROOM "/library/enchanter",
      "up" : JID_ROOM "/library/diviner",
   ]) );
  SetInventory( ([ JID_NPC "/gellin" : 1,
                   JID_NPC "/jacis" : 1,
              ]) );
