...
static void create() {
  ...
  SetLong("The marble outer wall of the shrine"
          ...
          " throughout the area. The path leads north and"
          " west around the perimeter of the shrine. To"
          " the east there is a small plot of land.");
  SetItems( ([
  ...
  SetExits( ([
           "north" : SHRINE_ROOM "room13",
           "west" : SHRINE_ROOM "room9",
           "east" : SHRINE_ROOM "room14",
          ]) );
  SetInventory( ([
           SHRINE_NPC "ghost2" : 3,
          ]) );
