...
static void create() {
  ...
  SetLong(
     "The path here leads upwards in the northeastern direction. A tower can "
     "be seen to the northeast, while the Taisoka Temple is seen to "
     "the west. The path is lined with flowers here which bloom in the "
  ...
  SetExits( ([
     "northeast" : N_ROOM + "n_path2",
    "west" : TAIRI_TOWNS "tairi/room/path8",
  ]) );
  }
