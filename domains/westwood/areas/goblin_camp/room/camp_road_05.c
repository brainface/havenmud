...
SetLong("This trail meanders farther away from the cobblestone road.  "
	...
	"used.  Evergreem trees flourish to the north and west while off "
	"to the south and west is a lake.  The trail leads northwest "
	"and southeast returning back to the cobblestone road.");
SetItems( ([
...
SetExits( ([
	"northwest" : G_ROOM + "camp_road_06",
	"southeast" : G_ROOM + "camp_road_04",
	]) );
}