...
static void create() { 
   ...
   SetLong("The robe seems to shine with joy and faith with its "
           "light demeanor.  It is made of a thin, lightweight "
   ...
   SetProperty("magic","This robe was blessed by Selket, the Goddess of "
               "Good, to protect her followers.");
   SetProperty("history","Selket, the Goddess of Good, blessed this robe "
