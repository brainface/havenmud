...
static void create() {
   post_office::create();
   SetTown("Thra");
   SetShort("the northern platform");
   SetLong("To one side of the platform is an area write mail and "
           "send mail and pick up mail, while other mail-related "
           "paraphernalia is scattered about the platform on the tops "
