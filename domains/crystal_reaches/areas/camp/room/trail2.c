...
static void create()  {
     ...
     SetDayLong("Deep ruts caused by wagon wheels "
           ...
           "to twist even more.  A large patch of dry "
           "land holds the remains of an old fire pit.  "
           "The trail passes the pit to continue "
    ...
    SetNightLong("A thick mist rises up from the "
           ...
           "bathes the swamp in silvery light.  The trail "
           "passes the remains of a fire pit to continue. "
           "to the northwest. ");
    SetItems( ([
             ("trail") : (: GetLong :),
             ({ "ruts", "deep ruts", "rut"}) :
	              ...
	              ({ "swamp", "swampy land", "ground",
                          "land",  "mud", "areas", "water"}):
                 "The swamp is mainly gray water thick "
                 "with mud.  Some areas are fairly solid "
                 "allowing for relatively safe travel. One "
                 "such area holds the remains of a fire pit "
                 "under one of the trees.  Many "
           ...
           ({"roots", "root"}):
            ...
            ("patch") : "The dry patch was used for an "
               "overnight camp.  The fire pit is just a few "
               "rocks and ashes. ", 
            ("pit") : "The fire pit is old.  Only a few rocks "
               "and ashes are left. ",
            ({"rocks", "circle", "rock"}):
               "The rocks are arranged " 
               "in a circle.",
            ({"ashes", "ash"}):
               "The ashes are scattered about the "
                "fire pit.",
            ("mist"):
    ...
    SetExits( ([
                       "northwest" :  C_ROOM + "trail3",
                       "southwest" : C_ROOM + "trail1",
                  ]) );
}
