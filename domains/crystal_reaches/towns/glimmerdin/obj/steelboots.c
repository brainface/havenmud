...
static void create() {
  ...
  SetKeyName("boots");
  SetId(( {"boots" } ));
  SetShort("a pair of small steel boots");
  SetAdjectives( ({"small", "steel", "pair of"}) );
  SetLong(
    "These sturdy boots are crafted of tough steel. The boots entirely cover the wearer's feet, leaving "
