...
*/
  ...
  SetLong(
     ...
     "high into the sky. A small canvas tent is seen directly to the south. "
  );
  SetItems( ([
     ...
     ({ "tent" }) : "A small canvas tent is seen directly to the south. ",
  ]) );
  SetItemAdjectives( ([
     "gate" : ({ "trading","post" }),
     "walls" : ({ "trading","post" }),
  ...
  SetExits( ([
     "north" : S_ROOM + "sulumus3",
     "northeast" : S_ROOM + "sulumus2",
     "east" : S_ROOM + "sulumus8",
  ]) );
}
