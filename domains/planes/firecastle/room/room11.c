...
static void create() {
   ...
   SetExits( ([ 
      "north" : FCASTLE_ROOM "room12",
      "down" : FCASTLE_ROOM "room10",
   ]) );
   SetInventory( ([
         FCASTLE_NPC "knight1" : 2,
   ]) );
   SetDoor("north", FCASTLE_OBJ "door1");   
  call_other( FCASTLE_OBJ "door1", "SetClosed", 1);
  call_other( FCASTLE_OBJ "door1", "SetLocked", 1);
}
