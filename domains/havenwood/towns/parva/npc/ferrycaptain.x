...
static void create() {
  ...
  SetAction(5, ({
    "!say Feel like I've been eat'n by ah pack ah wolves, an' shit right off a cliff.",
    ...
    "!yell HEY, KYLIN NAVY! I HEARD YOUR SHIPS ARE EMPTY CASKS, AND YOUR WOMEN ALL HAVE "
      "TUSKS!",
     "!board first ferry", // gets him back on his boat if he's on a dock, and his ship wasn't 
                           // there to begin with.
                           // I've made npc shipcaptains no longer autoboard on "coastal" areas.
  }) );
  SetInventory( ([
...
int eventReceiveObject(object ticket) {
  ...
  if (
    destination = ticket->GetProperty("parva_charter_ticket")
    )
    {
