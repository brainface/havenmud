...
static void create() {
   ...
   SetLevel(4+random(3));
   SetKeyName("nopatient");
   SetId( ({ "nopatient" }) );
   switch(random(8)) {
      case 0:
      SetShort("a plump nopatient");
      SetAdjectives( ({ "hospital","plump" }) );
      SetLong("The nopatient is fat; there is little else to it.  " +
      ...
      break;
      case 1:
      SetShort("a tall nopatient");
      SetAdjectives( ({ "hospital","tall" }) );
      SetLong("The hospital nopatient is tall and was once quite strong, "
      ...
      break;
      case 2..7:
      SetShort("a plain hospital nopatient");
      SetAdjectives( ({ "plain","hospital" }) );
      SetLong("Little distinguishes this nopatient from any other, except, "
