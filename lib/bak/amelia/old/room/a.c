...
static void create() {
   ...
   SetInventory( ([
                    "/realms/amelia/obj/bottle" : 5,
                    "/realms/amelia/obj/cookies" : 10,
                    "/realms/amelia/obj/cookieg" : 10,
                    "/realms/amelia/obj/toy" : 10,
                    "/realms/duuktsaryth/npc/thing" : 5,
               ]) );
