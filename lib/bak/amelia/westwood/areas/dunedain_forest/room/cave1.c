...
SetClimate("indoors");
  ...
  SetListen( ([ "default" : "A rumbling from behind the boulders is barely "
                            "audible."]) );
  ...
  SetItems( ([
               ...
               ({ "small path","path","wooded area","area" }) :
                  "A small path leads out of the cave towards a wooded area "
                  "to the east.",
               ...
               ({ "few large boulders","few boulders","large boulders",
                  "boulders","large boulder","boulder","back of cave",
                  "back"}) :
