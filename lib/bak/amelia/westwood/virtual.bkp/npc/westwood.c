...
void SetupRoom(int x, int y) {
 ...
 items = ([
  ...
  if (( x == XLine) && (y = YLine)) {
    ...
    ob->eventMove("/domains/new_westwood/virtual/westwood/" + loc);
 }
   }
  if ((x == 0) && (y == 0) ) {
    long += "  There appears to be a path leading southwest "
      "from here while Soleil Road leads southwest.";
    short = "a break in the WestWood";
    AddExit("southwest","/domains/new_westwood/virtual/soleilroad/20,20",(:PreExit:));
  ...
  if ((x == 0) && (y == 7) ) {
    ...
    RemoveExit("east");
    SetObviousExits("north, south, west, northwest, northeast, "
      "southeast, southwest");
   }
  if ((x == 0) && (y == 8) ) {
  ...
  if ((x == 0) && (y == 29) ) {
    long += "  The forest opens into a mountain trail to the northwest and "
      "a path seems to lead southeast.";
    short += "a break in the WestWood";
    AddExit("northwest","/domains/new_westwood/areas/hiker/trailhead");
    items = ([
  ...
  if ((x == 5) && (y == 15) ) {
    ...
    AddExit("northwest","/domains/new_westwood/areas/dunedain_forest/forest1");
    short = "a break in the WestWood";
    items = ([
      ({ "path" }) : "A small dirt path is worn into the ground here leading "
  ...
  if ((x == 9) && (y == 6) ) {
    ...
    AddExit("west","/domains/new_westwood/areas/goblin_camp/camp_road_01");
    short = "a path in the WestWood";
    items = ([
      ({ "path" }) : "A small dirt path is worn into the ground here leading "
        "north and south.",
  ...
  if ((x == 10) && (y == 9) ) {
    long += "  There appears to be a path leading northeast, northwest, "
  ...
  if ((x == 11) && (y == 10) ) {
    long += "  There appears to be a path leading east and southwest "
      "from here.";
    short = "a path in the WestWood";
    items = ([
      ({ "path" }) : "A small dirt path is worn into the ground here leading "
  ...
  if ((x == 17) && (y == 29) ) {
    ...
    RemoveExit("west");
    RemoveExit("southwest");
    SetObviousExits("north, south, east, northwest, northeast, southeast");
   }
  if ((x == 18) && (y == 8) ) {
  ...
  if ((x == 18) && (y == 15) ) {
    ...
    AddExit("up","/realms/gabriel/soleil/room/gate");
    RemoveExit("southwest");
    RemoveExit("south");
    RemoveExit("north");
    RemoveExit("northeast");
  ...
  if ((x == 19) && (y == 17) ) {
    ...
    AddExit("west","/domains/new_westwood/areas/hospital/room/start");
    short = "a path in the WestWood";
    items = ([
      ({ "path" }) : "A small dirt path is worn into the ground here leading "
        "northwest and south.",
