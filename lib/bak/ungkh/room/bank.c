...
static void create() {
  ...
  SetLong(
    ...
    "than having been made for a reason.  A shack "
    "resides by the side of the road."
    );
  SetSmell( ([
    "default" : 
  ...
  SetItems( ([
    ...
    ({ "shack" }) :
       "This small shack seems to be a place of currency.",
    ]) );
  SetItemAdjectives( ([
  ...
  SetExits( ([
    "south" : U_ROOM + "thief01",
    "west" : U_ROOM + "hall01",
    "north" : U_ROOM + "hospital",
    ]) );
  }
