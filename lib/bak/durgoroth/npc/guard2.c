...
static void create() {
  ...
  SetReligion("Saahagoth");
	...
	SetAction( 20, "The Durgoroth Guard hefts his weapon impatiently.");
	SetCombatAction( 25, (: DoAction :) );
	SetFriends( friends );
	SetWander( 3 + random(5), ({ "go up","go east","go east","go east",
		"enter tower","go north","go north","go north","go south",
		"go down","go west","go west","go west","go north","go north",
		"go south","go south","go west","go west","go west","go up",
		"go north","go south","go south","enter tower","go east",
		"go east","go east","go east","go down" }), 1 );
	}
