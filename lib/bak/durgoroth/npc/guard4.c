...
static void create() {
  ...
  SetReligion("Saahagoth");
	...
	SetFriends( friends );
	SetWander( 3 + random(5), ({ "go east","go east","go east",
		"go up","go north","go south","go south","enter tower",
		"go west","go west","go west","go west","go west","go west",
		"go west","enter tower","go north","go north","go north",
		"go south","go down","go east","go east","go east",
		"go north","go north","go south","go south" }), 1 );
	}
