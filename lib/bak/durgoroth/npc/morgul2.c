...
static void create() {
     ...
     SetLong("Morgul the Demon Lord and the High Priest of Saahagoth, "
          	 "formost deciple of the Mistress of the dark flame. He is a huge and "
          	 ...
          	 "easilly rip any mortal into shreds in a heartbeat.");
     SetRace("daemon");
     SetClass("priest");
     SetUniqueSkills( ([
        "blunt combat" : 0,
...
int AddEnemy( object ob ) {
     ...
     if (!ob->GetProperty("morgul_attacker")) {
          ...
          ob->SetProperty("morgul_attacker",1);
