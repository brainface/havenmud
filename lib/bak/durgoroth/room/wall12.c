...
// Date: January 1998
// Abstract: Southeastern tower of the Durgoroth town
//
// Revision History:
//
...
static void create() {
	room::create();
	SetTown("Durgoroth");
	SetShort("southeastern guard tower");
	SetLong("This tower lies "
		"at the intersection of the eastern and southern walls "
		"of the fortress. Two wooden doors lead out of the "
		"tower, one to the north and one to the west. At the "
	...
	SetAmbientLight(35);
	SetObviousExits("north, west, up");
	SetItems( ([
		({"southeastern guard tower", "guard tower", "tower"}) : 
