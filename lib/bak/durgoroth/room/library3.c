...
// Date: February 1998
//
// Abstract: Inside the Durgoroth library: Language teacher's room
//
// Revision History: 
//
...
static void create() {
	room::create();
	SetTown("Durgoroth");
	SetShort("north end of the Durgoroth library");
	SetLong("This huge stone edifice contains the massed knowledge "
		...
		"With a larger path leading to the south.");
	SetClimate("indoors");
