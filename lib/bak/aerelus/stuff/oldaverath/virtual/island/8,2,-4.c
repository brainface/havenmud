...
static void create() {
    ...
    SetLong(
    "A deep rumbling echos through the grey rock which forms this "
    "cave, indicating the action of ocean waves somewhere nearby. "
    "Curved lines and ripples decorate the walls while scattered "
    "pockmarks coat the ground. All were created by the rhythmic "
    "and constant action of the ocean over the years. A thick dark "
    "layer of blue lichen covers the ceiling, glowing slightly "
    "and illuminating the cave."
    );
    SetListen(
