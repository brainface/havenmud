...
static void create() {
  ...
  SetLong("This is a small bazaar in the middle of the plains of Averath. "
          ...
          "canvas covering. Wares line the table on all "
          "sides. The grass is scarce as if the area around "
          "the table has been trampled. Just north of here is the sea.");
  SetItems( ([
   ({ "booth" }) : (: GetLong :),
   ({ "grass","ground","area" }) :
  ...
  SetInventory( ([ BAZAAR_NPC + "fish_vendor" : 1,
                   ...
                   BAZAAR_NPC + "farmer" : 1, ]) );
  SetSmell( ([
     "default" : "Open air relieves the smell of fish.",
  ]) );
  SetListen( ([
