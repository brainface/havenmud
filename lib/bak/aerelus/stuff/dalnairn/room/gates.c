...
static void create() {
  ...
  SetLong(
    ...
    "population of duergar who follow the Soirin faith, it is a beautiful "
    ...
    "mineraloid which the duergar have been mining from this now dormant, "
    "grass-covered volcano. The path leads down the mountain, while the city "
    "lies west."
  );
  SetItems( ([
  ({ "path" }) :
  ...
  AddExit("down", DAL_ROOM "gates", (: PreExit :) );
}
