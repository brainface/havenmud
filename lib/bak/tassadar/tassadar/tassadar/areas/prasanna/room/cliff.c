...
static void create() {
   ...
   SetLong("A small path emerges from the cave, and nearly walks straight off "
           ...
           "mighty mountain, had it's peak leveled off to accomodate the city "
           "now nestled upon it. To the east, a wide road of white stone "
           "begins it's trek towards the city. ");
   SetItems( ([ 
      ({ "path" }) :
          "This path emerges from a nearby cave and turns sharpy to the east.",
      ({ "edge" }) :
   ...
   SetListen( ([
       "default" : "The wind whistles along the cliff."
   ]) );
}
