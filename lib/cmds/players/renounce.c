...
mixed cmd(string args) {
  ...
  if (who->GetSkillLevel("faith") || who->GetClass() == "mystic" || who->GetClass() == "druid" || who->GetClass() == "contemplator" ) {
      // who->RemoveClass();
      who->eventPrint("Members of your class cannot renounce their faith.");
      return 1;
  }
