...
// Filename: dcyan_robe.c
// Author: Derek Noble
// Angel: dylanthalus@haven
// Creation Date: December 17th, 1998
// Abstract: just a standard dark cyan robe of not too much extravagence.
// Revision History: 
/* ----------------------------------------------------------------------- */
...
static void create() {
  ...
  SetKeyName("dark cyan robe");
  SetId( ({ "robe" }) );
  SetShort("a dark cyan robe");
  SetAdjectives( ({ "dark","cyan"}) );
  SetLong("The dark cyan robe is nothing out of the ordinary, but it is "
