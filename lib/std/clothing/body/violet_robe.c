...
// Filename: violet_robe.c
// Author: Derek Noble
// Angel: dylanthalus@haven
// Creation Date: December 17th, 1998
// Abstract: just a standard violet robe of not too much extravagence.
// Revision History: 
/* ----------------------------------------------------------------------- */
...
static void create() {
  ...
  SetAdjectives( ({ "violet"}) );
  SetLong("The violet robe is nothing out of the ordinary, but it is "
