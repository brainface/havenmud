...
// Filename: turquoise_robe.c
// Author: Derek Noble
// Angel: dylanthalus@haven
// Creation Date: December 17th, 1998
// Abstract: just a standard turquoise robe of not too much extravagence.
// Revision History: 
/* ----------------------------------------------------------------------- */
...
static void create() {
  ...
  SetKeyName("turquoise robe");
  SetId( ({ "robe" }) );
  SetShort("a turquoise robe");
  SetAdjectives( ({ "turquoise" }) );
  SetLong("The turquoise robe is nothing out of the ordinary, but it is "
