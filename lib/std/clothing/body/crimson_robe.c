...
// Filename: crimson_robe.c
// Author: Derek Noble
// Angel: dylanthalus@haven
// Creation Date: December 17th, 1998
// Abstract: just a standard crimson robe of not too much extravagence.
// Revision History: 
/* ----------------------------------------------------------------------- */
...
static void create() {
  ...
  SetKeyName("crimson robe");
  SetId( ({ "robe" }) );
  SetShort("a crimson robe");
  SetAdjectives( ({ "crimson" }) );
  SetLong("The crimson robe is nothing out of the ordinary, but it is "
