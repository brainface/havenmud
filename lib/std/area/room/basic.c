 ...
 * (type cd .. for an example of how .. works)
 */
 ...
 * rooms can use SetItemAdjectives, while npcs use SetAdjectives
 */
 ...
 */
  ...
  SetItemAdjectives( ([
    ...
    "tapestry" : ({"colorful", "intricate", "amazing"}),
  ]) );
 ...
 *  to <look at colorful tapestry> and is a required function.
 */
 ...
 *  Note that on Haven the room lib uses this data to return the
 *  Obvious exits that players see in a room, so they don't need
 *  to be manually set, as on some other muds.
 */
