...
// Added Everything
// Urien@Haven 5.16.23
// Campfire eats the world, a unique bug. swapped inherits and includes
...
SetItems( ([ 
    ...
    ({ "floor","ground" }) : "The ground is made of yellowed "
     ...
     "mat" : "A singular mat on closer inspection it is just made "
             "of dried straw from the WestWood elements.",
    ]) );
