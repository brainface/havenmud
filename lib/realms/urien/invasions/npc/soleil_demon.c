...
int eventDie(object killer) {
  ...
  object lizard_inv_3;
  if(!random(1)) {
    lizard_inv = new(DIR_INVASIONS + "/soleil_demon/dis_inv");
    INVASION_D->eventRegisterInvasion(lizard_inv, killer);
    lizard_inv_2 = new(DIR_INVASIONS + "/soleil_demon/dis_2_inv");
    INVASION_D->eventRegisterInvasion(lizard_inv, killer);
    lizard_inv_3 = new(DIR_INVASIONS + "/soleil_demon/dis_3_inv");
    INVASION_D->eventRegisterInvasion(lizard_inv, killer);
  }
