...
//
// torak@haven
// slightly altered, dalnairn recode 2019
...
static void create() {
  ...
  SetLong(
    ...
    "arrogant dwarf, and honestly believes he is superiour to everyone in the "
  ...
  SetLevel(80);  
  SetMorality(-200);
  SetCurrency("shards", random(100)+600);
  SetInventory( ([
  ...
  SetAction(5, ({
    "!speak Got what it takes to join the guard, little one?",
  	}) );
  SetCombatAction(5, ({
    "!disarm",
    "!disorient",
