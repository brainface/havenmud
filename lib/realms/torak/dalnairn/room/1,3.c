...
static void create() {
  ...
  SetLong(
    "The fine white sand of the beach continues to the northwest and "
    "southeast while to the south it is more alive with the tides of "
   "the bay. The beach ends further northwest where it meets the cliff "
    ...
    "north and east. Further southeast, the makings of a town "
    "break the tranquility of sand. To the south across the water lies a pier.",
  );
  SetItems( ([
    ...
    ({ "bay", "water", "waters", "sunlight", "moonlight", 
      ...
      "on the beach to the west and south.",
    ({ "sand" }) : 
  ...
  SetExits( ([
    "northwest" : DAL_ROOM "0,4.c",
    "north" : DAL_ROOM "1,4.c",
    "east" : DAL_ROOM "2,3.c",
    "southeast" : DAL_ROOM "2,2.c",
