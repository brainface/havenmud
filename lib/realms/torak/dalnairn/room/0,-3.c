...
static void create() {
  ...
  SetDayLong(
    ...
    "The ridge opens out northwest to the sea while to the north "
    ...
    "The outermost arms of the ridge lie to the northwest "
  ...
  SetNightLong(
    ...
    "The bay extends out to the north while the beach is to the south and east. "
  ...
  SetExits( ([
    "north" : DAL_ROOM "0,-2.c",
    "northeast" : DAL_ROOM "1,-2.c",
    "east" : DAL_ROOM "1,-3.c",
    "south" : DAL_ROOM "0,-4.c",
    "west" : DAL_ROOM "-1,-3.c",
  ]) ); 
  SetEnters( ([
  ]) );
...
void heart_beat() {
  ...
  switch(random(6)) {
    ...
    break;
    case 2:
      wave = "%^CYAN%^Waves crash gently across the beach.%^RESET%^";    break;
    case 3:
