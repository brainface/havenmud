...
static void create() {
  ...
  SetLong(
    "The fine white sand of the beach continues to the northeast while "
    "to the north it is more alive with the tides of the bay. The cliff arms of the "
    "ridge abruptly prevent travel to the south. "
    "A clearing has been cut out of the forest to the east. "
  ...
  SetExits( ([
    "north" : DAL_ROOM "0,-3.c",
    "northeast" : DAL_ROOM "1,-3.c",
    "east" : DAL_ROOM "1,-4.c",
  ]) ); 
  SetEnters( ([
  ]) );
