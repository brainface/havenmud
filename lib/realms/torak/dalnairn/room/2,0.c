...
static void create() {
  ...
  SetLong(
    ...
    "A store has been erected here. "
    "The boardwalk stretches north and south to the edges of town. "
    "To the west a pier stretches into the bay. "
    "The beach is to the north and south while the town is ringed with a "
    "crescent forest and mountain ridge.",
  );
  SetItems( ([
    ({ "store", "building" }) : 
       "A wooden store has been erected here on the boardwalk. ",
    ({ "beam", "beams" }) : 
    ...
    ({ "town", "boardwalk" }) : 
      "The town sits upon en elevated wooden boardwalk. A pier just out to the west.",
    ({ "forest" }) : 
  ...
  SetSmell( ([
    "default" : "The air smells of salt and life.",
  ]) );
  SetExits( ([
