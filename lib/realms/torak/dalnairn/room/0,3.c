...
static void create() {
  ...
  SetDayLong(
    ...
    "The ridge opens out southwest to the sea while to the south "
    ...
    "The outermost arms of the ridge lie to the southwest "
  ...
  SetNightLong(
    ...
    "The bay extends out to the south while the beach is to the north and east. "
  ...
  SetExits( ([
    "west" : DAL_ROOM "-1,3.c",
    "north" : DAL_ROOM "0,4.c",
    "east" : DAL_ROOM "1,3.c",
    "southeast" : DAL_ROOM "1,2.c",
    "south" : DAL_ROOM "0,2.c",
  ]) ); 
  SetEnters( ([
  ]) );
}
