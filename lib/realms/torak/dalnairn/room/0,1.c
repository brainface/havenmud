...
static void create() {
  ...
  SetDayLong(
    ...
    "The ridge opens out west to the sea while to the southeast "
    "there is a pier and a town that sits nestled on a beach. A crescent "
  ...
  SetExits( ([
    ...
    "east" : DAL_ROOM "1,1.c",
    "southeast" : DAL_ROOM "1,0.c",
    "south" : DAL_ROOM "0,0.c",
    "southwest" : DAL_ROOM "-1,0.c",
    "west" : DAL_ROOM "-1,1.c",
  ]) ); 
  SetEnters( ([
  ]) );
