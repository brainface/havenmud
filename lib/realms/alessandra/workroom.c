...
static void create() {
  ...
  SetClimate("indoors");
  SetAmbientLight(40);
  SetShort("a tiny cubicle floating in space ");
  SetLong(
    "You're in a tiny cubicle, anchored to a pathetic little asteroid, slowly floating through the void of space. Reams of forms "
    "and files are piled haphazardly within the dingy, broken walls and occassionally break free of the meagre gravity to float off into "
    "the darkness. An old beige computer flickers still with some life, Excel 97 open with multiple tabs waiting to be filled out. The "
    "chair, at least, does look comfortable and swively. It's probably easy to dance in, if squeaky."
     );
  SetItems( ([
  ...
  SetExits( ([
    "north" : DIR_STANDARD_DOMAIN "/staffroom",
     ...
     "south" : "/domains/estergrym/areas/vampire/room/gypsycamp",
  ]) );
  Shielded = 0;
  SetSmell( ([
    "default" : "It reeks of spilt coffee.",
    ]) );
  SetListen( ([
    "default" : "The phone is making that off the ringer beepbeepbeep.",
    ]) );
  SetInventory( ([
