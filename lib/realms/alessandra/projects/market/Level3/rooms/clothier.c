...
static void create() {
  ...
  SetLong(
     ...
     "the back counter, covered in a deep burgandy velvet. A stairway on the "
  ...
  SetItems( ([
     ...
     ({"curtain", "curtains"}) :
     	 ...
     	 "burgandy sashes have been used to tie them open.",
     ({"window", "windows"}) :
     	 "The windows are lined with beautiful sheer curtains.",
     ({"sash", "sashes"}) :
     	 "Deep burgandy in color, these tassled sashes tie the sheer curtains "
     	 "open.",
     ({"chair", "chairs"}) :
     	 "Large and comfortable looking, these chairs are covered in a dark "
     	 "burgandy velvet. They sit on either side of the counter, welcoming "
  ...
  SetItemAdjectives( ([
     ...
     "curtain" : ({"sheer", "rose"}),
     "sash" : ({"tassled", "burgandy"}),
     "chair" : ({"large", "comfortable", "velvet", "burgandy"}),
     "counter" :({"tidy"}),
     "stairs" : ({"narrow"}),
     "floor" : ({"tidy"}),
     "wall" : ({"painted"}),
