...
static void create() {
  ...
  SetDayLong(
     ...
     "lodge sits to the west, smoke billowing from its chimney. Prints "
     "in the snow are those of animals seeking shelter and fresh pairs of "
     "large footprints. Light spilling though the arms of the trees and "
     "reflecting off the snow is more than enough to brighten the area. "
     "The pathway continues east and west."
     );
  ...
  SetExits( ([
     "east" : L_ROOM + "outside13.c",
     "west" : L_ROOM + "outside19.c",
     ]) );
