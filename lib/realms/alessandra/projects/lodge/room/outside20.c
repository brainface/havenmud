...
static void create() {
  ...
  SetDayLong(
     ...
     "lodge sits to the north, smoke billowing from its top. There is no "
     "entrance to it from this side. Prints in the snow are those of "
     "animals seeking shelter and a fresh pair of large footprints. "
  ...
  SetExits( ([
     "northwest" : L_ROOM + "outside17.c",
     "northeast" : L_ROOM + "outside19.c",
     "south" : L_ROOM + "outside16.c",
     ]) );
