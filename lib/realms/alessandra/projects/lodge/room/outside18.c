...
static void create() {
  ...
  SetDayLong(
     ...
     "lodge sits to the south, smoke billowing from its top. There is "
   ...
   SetNightLong("Dead trees line this small pathway through the forest, "
     ...
     "all directions like giant claws. The ground is covered in a thick "
     "layer of dismal gray snow, lifeless bushes piercing through it. A "
     "lodge sits to the south, smoke billowing from its top. There is no "
  ...
  SetItems( ([
     ...
     ({"path","pathway","passage"}) : "This pathway seems narrow and rarely "
       "used, though footprints lead around the outside of the lodge.",
  ...
  SetExits( ([
     "north" : L_ROOM + "outside12.c",
     "southeast" : L_ROOM + "outside19.c",
     "southwest" : L_ROOM + "outside17.c",
     ]) );
