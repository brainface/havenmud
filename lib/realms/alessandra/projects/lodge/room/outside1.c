...
static void create() {
  ...
  SetClimate("arctic");
  SetShort("a cold pathway through the forest");
  SetDayLong(
     ...
     "The pathway continues to the east and west."
     );
  ...
  SetExits( ([
     "east" : L_ROOM + "outside2.c",
     ]) );
  AddExit("west", FROSTMARCHES_VIRTUAL "durgorothroad/-10,12");
}
