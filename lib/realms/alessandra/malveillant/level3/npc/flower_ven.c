...
static void create() {
  ...
  SetMenuItems( ([
    "red rose" : MAL_OBJ3 + "flwr_redrose",
    "lily" : MAL_OBJ3 + "flwr_lily",
    "anemone" : MAL_OBJ3 + "flwr_anemone",
    "hellebore" : MAL_OBJ3 + "flwr_hellebore",
//  "bouquet of black roses" : MAL_OBJ3 + "flwr_blackbouq",
     ]) );
  SetAction(5, ({ 
