...
SetMorality(-250);
SetLevel(45);
SetCombatStyleLevel("dirty tricks", 75);
...
SetInventory( ([
 ...
 object *questee = ({ });
 questee = filter(all_inventory(environment(who)), (: playerp($1) && ($1->GetProperty("LordBQuestStage2pt3") == 1) :));
 
 questee->RemoveProperty("LordBQuestStage2pt3");
