...
static void create() {
  ...
  SetLong(
   ...
   "of Drazh. The walls of the passageway are cracked in more than one place. "
  ...
  SetItems( ([
     ({"main road"}) :
     "The smaller stone tiled passageway heads south away from the main "
     "road of Drazh.",
  ...
  SetSmell( ([
     "default" : 
     "The slight scent of buring wood and metal wafts in the air.",
     ]) );
  SetInventory( ([
     V_NPC + "citizen" :1,
     ]) );
  SetExits( ([
     "north" : V_ROOM + "main_road/main4",
     "south" : V_ROOM + "main_road/s_road2",
     ]) );
  }
