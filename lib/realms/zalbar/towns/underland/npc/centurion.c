...
static void create() {
  ...
  SetLong(
    ...
    "flesh of this thing is writhing with psionic energies swirling "
    "with his every movement. His armour floats amongst the dancing"
    ...
    "a swirling mist of energies that seem to carry him forth."
    );
  SetClass("fighter");
  SetClass("priest");
