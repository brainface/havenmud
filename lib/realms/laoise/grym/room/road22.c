...
static void create() {
  ...
  SetLong(
    ...
    "gothic style cathedral that was formerly dedicated to "
    "Saahagoth but now houses many religions, can be seen. "
    "To the east is Kintara's House of Bargains."
  );
  SetItems( ([
    ...
    ({"house of bargains", "kintara's", "house", "store" }) :
