...
static void create()  {
  ...
  SetLong("A endless, dead, dry plain. There is not much of interest here. "
           "Nothing can be seen  but the dead "
           "land rolling away over the horizon. A road can be seen to the north. "
           "And a field of brown plants can be seen to the east.");
  SetObviousExits("north, south, east");
  SetExits( ([
           "south" : G_ROOMS + "/room51",
           "north" : G_ROOMS + "/room56",
           "east" : G_ROOMS + "/room54"]) );
  SetItems( ([
  ...
  SetListen( ([
          "default" : "A faint squealing sound can be heard nearby."]) );
  }
