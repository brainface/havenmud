...
static void create() {
  ...
  SetExits( ([
    "northeast" : FOREST_ROOM "f01",
    "southwest" : FOREST_ROOM "f03",
    ]) );
  ...
  SetLong(
    ...
    "to lead off to the southwest even deeper into the forest, while "
    "to the northeast the trees become less dense and the path leads "
  ...
  SetItems( ([
    ...
    "underbrush" : "The underbrush is loose growing things that are not "
                   "trees.",
    "path" : "The path leads northeast and southwest from here.",
    ]) );
  SetInventory( ([
    FOREST_NPC "deer" : 1,
    ]) );                                
