...
static void create() {
  ...
  SetShort("the fighter road");
   SetLong(
     ...
     "fighter hall stands directly off to the west, while the main road "
  ...
  SetItems( ([
     ...
     ({"hall","fighter hall"}) : "The fighter hall stands directly "
     "to the west. The building appears to be carved out of the "
     "stone from the mountains. It stands over rest of the buildings "
     "along the road. ",
  ...
  SetEnters( ([
     "fighter hall" : V_ROOM + "fighter_hall/fh1",
  ]) );
  SetInventory( ([
  ]) );
  SetExits( ([
     "east" : V_ROOM + "fighter_road/fr3",
  ]) );
  }
