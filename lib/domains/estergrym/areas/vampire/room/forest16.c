...
static void create() {
  ...
  SetLong(
     ...
     "to determine whether it is light out. The trail winds only to the "
     "southeast from here."
     );
  SetSmell( ([
     "default" : "The air is filled with the musty smell of dirt and decay.",
     ]) );
  SetListen( ([
  ...
  SetItems( ([
     ({"path", "pathway", "trail"}) : "Surrounded by dense forest the small "
       "path wends its way bath to the southeast from here. Littered "
