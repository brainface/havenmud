...
static void create() {
  ...
  SetLong(
     "The path continues to the northeast and southwest, the trees "
     "crowding the small trail. The ground shows no sign that "
  ...
  SetExits( ([
     "northeast" : VAMP_ROOM + "forest8",
     "southwest" : VAMP_ROOM + "forest12"
     ]) );
