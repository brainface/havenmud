...
static void create() {
  ...
  SetLong(
     "A path winds its way through the forest to the northwest and "
  ...
  SetItems( ([
     ({"path", "pathway", "trail"}) : "Surrounded by dense forest the small "
       "path wends its way to the northwest and southwest from here. Littered "
  ...
  SetExits( ([
     "northwest" : VAMP_ROOM + "forest16",
     "southwest" : VAMP_ROOM + "forest14",
     ]) );
