...
static void create() {
  ...
  SetLong(
     "The path continues to the northwest and east, the trees "
  ...
  SetItems( ([
     ({"path", "pathway", "trail"}) : "Surrounded by dense forest the small "
       "path wends its way to the northwest and east from here. Littered "
  ...
  SetExits( ([
     "northwest" : VAMP_ROOM + "forest8",
     "east" : VAMP_ROOM + "forest6",
     ]) );
