...
static void create() {
  ...
  SetLong(
     "The ground shows no sign that anyone has traversed it before, "
     "dead and brittle leaves lay undisturbed. There aren't even signs "
     "of small animals or insects about. The trees are dense despite, "
     "for all appearances, being dead, and long spindly branches reach "
     "out over the small pathway. The density of the tree branches "
     "and the misty fog that rolls through regularly make it hard "
     "to determine whether it is light out. The path continues to the "
     "northeast and southwest, the trees crowding the small trail." 
     );
  SetSmell( ([
  ...
  SetItems( ([
     ({"path", "pathway", "trail"}) : "Surrounded by dense forest the small "
       "path wends its way to the northeast and southwest from here. Littered "
  ...
  SetExits( ([
     "northeast" : VAMP_ROOM + "forest6",
     "southwest" : VAMP_ROOM + "forest4",
     ]) );
