...
static void create() {
  ...
  SetLong("A very large chamber, the ceiling can not be seen in the "
         "darkness. The chamber extendeds further north. All around "
         ...
         "citizens huddle around three small fires talking quietly about "
         "the horrors in the depths.");
  SetExits( ([
          "north" : U_ROOM + "room11a"]) );
  SetItems( ([
