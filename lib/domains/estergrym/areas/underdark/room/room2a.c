...
static void create() {
  ...
  SetLong("On the foot of a small mountain. The land all around seems "
          ...
          "in the northeast is the peak of the mountain. A cave opening can be "
          "seen a off to the northeast, yawning open like some foul "
  ...
  SetSmell( ([
          "default" : "They air has a dusty smell."]) );
  SetListen( ([
