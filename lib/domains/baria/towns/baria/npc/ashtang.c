...
static void create() {
  ...
  SetAdjectives( ({"leader","courageous","fierce","adept",
                   "powerful"}) );
  SetLong("This female draconian is the fighter leader of Baria. She "
  ...
  SetInventory( ([
                  BARIA_OBJ + "bone_sword" : "wield sword"
              ]) );
  SetCurrency( ([
                 "chits" : random(1000)
             ]) );
  ...
  SetPlayerTitles( ([
                     "newbie" : "the Trainee Warrior of Baria",
                     "mortal" : "the Warrior of the Jungle",
                     "hm"     : "the Destroyer Warrior of Baria",
