...
static void create() {
   ...
   SetLong("The small barren field is covered in sun burnt grass "
           ...
           "is a circular pattern here that looks to have been "
           ...
           "One could also travel south, east or northeast "
           "further into the dreaded barren fields. However "
           "they could also travel southeast towards what "
...
SetExits( ([ "north" : AVB_FIELD + "field1", 
             "south" : AVB_FIELD + "field3",
             "east" : AVB_FIELD + "field6",
             "southeast" : AVB_FIELD + "field7",
             "northeast" : AVB_FIELD + "field5",
        ]) );
...
varargs mixed eventDig(object who, string what) {
  object key = new(AVB_OBJ "circle_key");
