...
static void create() {
   ...
   SetLong("Beautiful paintings are displayed on the walls "
           ...
           "A door leads on in the south wall.");
   SetItems( ([
                ...
                ({ "beautiful paintings","paintings","painting",
                   ...
                   "walls except for the south one.",
                ({ "soft bench","bench" }) :
                   ...
                   "view the paintings.",
                ({ "south door","door","wall" }) :
                   "The south door leads out of the gallery; it is the "
                   "only exit.  The south wall is the only wall "
