...
static void create() {
  ...
  SetKeyName("Rook");
  SetId( ({ "dragon", "rook" }) );
  SetShort("Rook, a gargantuan silver dragon");
  SetAdjectives( ({ "gargantuan", "silver", "rook", "dragon" }) );
  SetLong(
    "This huge dragon that stands here is known as Rook.  She is gargantuan "
