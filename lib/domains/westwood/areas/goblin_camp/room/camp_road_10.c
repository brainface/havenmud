...
SetItems( ([
        ({ "tent" }) : (: GetLong :),
        ({ "floor" }) : "The floor is nothing more than packed dirt.",
        ...
        ({ "goblin","goblins" }) : "The goblins are outside the tent.  None "
                "would be brave enough to enter here.",
        ]) );
SetItemAdjectives( ([
        "goblin" : ({ "brave"}),
        "wall" : ({ "green" }),
...
SetListen( ([
        "default" : "The inside of the tent is very quiet.",
        ]) );
SetSmell( ([
