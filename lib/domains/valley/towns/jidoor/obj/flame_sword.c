...
static void create() {
  ...
  SetProperty("history","This sword provides "
    "divine punishment by the power of the Lord of Elemental "
    "Energies.");
  SetProperty("magic","It's literally on fire. You needed magic to "
    "tell you this.");
