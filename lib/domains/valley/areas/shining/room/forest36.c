...
SetItems( ([
     ...
     ({ "stone" }) : 
                  "The stones here seem to be lined up perfectly with the "
                  "next. They are many different shapes and sizes. Some "
                  "are tan in color while the others are brown. ",
  ]) );
...
SetExits( ([
    "west" : SF_ROOM "forest35",
    "east" : SF_ROOM "forest37",  
  ]) ) ;
}
