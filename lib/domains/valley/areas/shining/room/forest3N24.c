...
static void create() {
  ...
  SetLong(
    ...
    "continues north along the edge of the forest. The only other "
    "direction of travel would be back south towards the opening of "
    "the shining forest. " );
SetItems( ([
     ...
     ({ "beautiful forest", "shining forset", "trees" , "tree", 
        "large trees", "large tree" }) : 
                  ...
                  "about fifteen feet up them. Many of the the "
                  "leaves on the trees are a glowing green.",
     ({ "sky" }) : 
...
SetExits( ([
    "north" : SF_ROOM "forest3N25",
    "south" : SF_ROOM "forest3N23",  
  ]) ) ;
}
