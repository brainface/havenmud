...
static void create() {
  ...
  SetLong(
    ...
    "strangely enough it seems to be rather bright here. A large "
    "log lies along side the path here. The path continues east "
    "along the stream further into the forest. The only other "
    "direction of travel would be back west towards the opening of "
    "the shining forest. " );
...
SetItems( ([
   ...
   ({ "sky" }) : 
     ...
     ({"log"}) :
                  "The log seems to have fallen recently. It has a "
                  "small hole.",
     ({"hole"}) :
...
SetExits( ([
    "west" : SF_ROOM "forest14",
    "east" : SF_ROOM "forest16",  
  ]) ) ;
}
