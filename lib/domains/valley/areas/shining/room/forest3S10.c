...
static void create() {
  ...
  SetLong(
    ...
    "continues south along the edge of the forest. The only other "
    "direction of travel would be back north towards the opening of "
    "the shining forest. " );
...
SetExits( ([
    "north" : SF_ROOM "forest3S9",
    "south" : SF_ROOM "forest3S11",  
  ]) ) ;
}
