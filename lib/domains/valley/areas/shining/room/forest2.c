...
static void create() {
  ...
  SetLong(
    ...
    "along each side of the path. Oddly, not one seems to be out of place. "
    "The very large trees here appear to be hundreds of years old. They "
    "stand so tall into the sky they block out even the smallest amount "
    "of sunlight. However, strangely enough it seems to be rather bright "
    "here. The path continues east along the stream further into the "
    "forest. The only other direction of travel would be back west towards "
...
SetExits( ([
    "west" : SF_ROOM "forest1",
    "east" : SF_ROOM "forest3",  
  ]) ) ;
}
