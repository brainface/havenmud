...
static void create() {
  ...
  SetLong("The ground here is little differant than the rest of the "
          ...
          "There is a large shrine to the northwest which appears "
         "to be occupied.");
  SetSmell( ([
  ...
  SetExits( ([
      "north" : FIRST_PLANE "-5,1",
      "south" : FIRST_PLANE "-5,-1",
      "east"  : FIRST_PLANE "-4,0",
      "west"  : FIRST_PLANE "-6,0",
      "northwest" : FIRST_PLANE "-6,1",
    ]) );
 }
