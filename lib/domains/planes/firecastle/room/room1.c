...
static void create() {
   ...
   SetItems( ([
      ...
      ({ "walls", "wall", "stone" }) :
         "The walls are completely bare except for a few scorch makers. They "
   ...
   SetExits( ([ 
      "northeast" : FCASTLE_ROOM "room3",
      "northwest" : FCASTLE_ROOM "room2",
   ]) );
   AddExit("out", "/domains/planes/virtual/fire/" + (x) + "," + (y) );
   SetInventory( ([
