...
static void create() {
   ...
   SetAmbientLight(35);
   SetLong(
     "The hallway continues to the east and back south through the large door. "
   ...
   SetExits( ([ 
      "south" : FCASTLE_ROOM "room11",
      "east" : FCASTLE_ROOM "room13",
   ]) );
   SetInventory( ([
         FCASTLE_NPC "rogue1" : 1,
         FCASTLE_NPC "mage1" : 1,
   ]) );
   SetDoor("south", FCASTLE_OBJ "door1");   
}
