...
inherit LIB_ROOM;
 ...
 static void create() {
  ...
  SetDayLong("The trees around this area are creepy looking. The trees "
         ...
         "Big footprints lead ahead in the trail, which curves slightly but sharply.");
  ...
  SetClimate("arctic");
   SetItems( ([
      ...
      ({"tracks","track"}) : "These tracks are left behind from small animals.  "
  ...
  SetItemAdjectives( ([
   ...
   SetExits( ([
      "east" : L_ROOM + "outside9.c",
      "west" : L_ROOM + "outside1.c",
   ]) );
   SetInventory( ([
L_NPC + "defender" : 1,
   ]) );
