...
static void create() {
  ...
  SetItems( ([
    ({"oils", "oil", "clump", "clumps", "bitumen", "ocean", "sea"}) :        
	  "The Oil Ocean extends in all directions, made of tar sands and "
      "black substances that swirl and shimmer and ooze mysteriously.",
	({"sands", "sand" "substance", "substances"}) :
      "The tar sands and black substances swirl, shimmer and ooze mysteriously.",
    ({"coral", "reef", "reefs", "forms", "house", "houses"}) :   
      "These reefs must have been the homes to tiny fish and other sea "
      "creatures in the forgotten past.",
  ]) );
  SetItemAdjectives( ([
    "oils" : ({"syrupy"}),
	"sands" : ({"tar"}),
  ...
  SetListen( ([
    "default" : 
    "A slurping noise comes from the ground, as though the oil "
	"digests everything that sinks down into it.",
  ]) );
  SetSmell( ([
