...
static void create() {
  ...
  SetItems( ([
    "floor" : "The floor is tiled with minute obsidian tiles, polished so that they reflect
everything.",
    "ceiling" : "The ceiling has been expensively frescoed with images of the tantalizing
goddess.",
    ({ "curtains", "walls" }) : "The walls are covered with black velvetine hangings embroidered
with gilt tassels.",
    "altar" : "The altar to Alessandra stands in the back of the shrine.",
    ({ "votives", "candles" }) : "The small candles offer little light.",
    "petals" : "The petals give off a undeniably sweet, seductive fragrance that cannot be
ignored.",
    ]) );
  SetReligion("Soirin");
  SetItemAdjectives( ([
