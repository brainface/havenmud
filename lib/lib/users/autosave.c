...
static void heart_beat() {
    ...
    if( playerp(this_object()) && !(this_object()->GetProperty("no_autosave_spam"))) {
        eventPrint("Your status has been recorded.");
        if (newbiep()) eventPrint("If you have questions, type \"help newbie\" or \"help basics\".");
    }
}
