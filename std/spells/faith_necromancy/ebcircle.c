...
static void create() {
  ...
  SetHelp(
    "This spell allows the caster to remove a black circle from the room. To use "
    "this spell simply cast it at the circle. This spell can also remove a great circle if the need arises."
    );
}
