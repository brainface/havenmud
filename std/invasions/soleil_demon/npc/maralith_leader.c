...
static void create() {
  ...
  SetLong(
    ...
    "ready for action. An intricate brand upon her forehead seems to "
    "indicate that she has some extra authority among the demons."
  );
  SetRace("maralith");
  SetGender("female");
  SetClass("fighter");
