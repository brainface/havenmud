...
// Filename: magenta_robe.c
// Author: Derek Noble
// Angel: dylanthalus@haven
// Creation Date: December 17th, 1998
// Abstract: just a standard magenta robe of not too much extravagence.
// Revision History: 
/* ----------------------------------------------------------------------- */
...
static void create() {
  ...
  SetKeyName("magenta robe");
  SetId( ({ "robe" }) );
  SetShort("a magenta robe");
  SetAdjectives( ({ "magenta"}) );
  SetLong("The magenta robe is nothing out of the ordinary, but it is "
