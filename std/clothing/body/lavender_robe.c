...
// Filename: lavender_robe.c
// Author: Derek Noble
// Angel: dylanthalus@haven
// Creation Date: December 17th, 1998
// Abstract: just a standard lavender robe of not too much extravagence.
// Revision History: 
/* ----------------------------------------------------------------------- */
...
static void create() {
  ...
  SetKeyName("lavender robe");
  SetId( ({ "robe" }) );
  SetShort("a lavender robe");
  SetAdjectives( ({ "lavender"}) );
  SetLong("The lavender robe is nothing out of the ordinary, but it is "
