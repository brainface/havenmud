...
// Filename: dbrown_robe.c
// Author: Derek Noble
// Angel: dylanthalus@haven
// Creation Date: December 17th, 1998
// Abstract: just a standard dark brown robe of not too much extravagence.
// Revision History: 
/* ----------------------------------------------------------------------- */
...
static void create() {
  ...
  SetKeyName("dark brown robe");
  SetId( ({ "robe" }) );
  SetShort("a dark brown robe");
  SetAdjectives( ({ "dark","brown"}) );
  SetLong("The dark brown robe is nothing out of the ordinary, but it is "
