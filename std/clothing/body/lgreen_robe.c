...
// Filename: lgreen_robe.c
// Author: Derek Noble
// Angel: dylanthalus@haven
// Creation Date: December 17th, 1998
// Abstract: just a standard light green robe of not too much extravagence.
// Revision History: 
/* ----------------------------------------------------------------------- */
...
static void create() {
  ...
  SetKeyName("light green robe");
  SetId( ({ "robe" }) );
  SetShort("a light green robe");
  SetAdjectives( ({ "light","green"}) );
  SetLong("The light green robe is nothing out of the ordinary, but it is "
