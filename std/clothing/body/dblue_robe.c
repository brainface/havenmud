...
// Filename: dblue_robe.c
// Author: Derek Noble
// Angel: dylanthalus@haven
// Creation Date: December 17th, 1998
// Abstract: just a standard dark blue robe of not too much extravagence.
// Revision History: 
/* ----------------------------------------------------------------------- */
...
static void create() {
  ...
  SetAdjectives( ({ "dark","blue"}) );
  SetLong("The dark blue robe is nothing out of the ordinary, but it is "
