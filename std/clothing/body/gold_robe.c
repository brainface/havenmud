...
// Filename: gold_robe.c
// Author: Derek Noble
// Angel: dylanthalus@haven
// Creation Date: December 17th, 1998
// Abstract: just a standard gold robe of not too much extravagence.
// Revision History: 
/* ----------------------------------------------------------------------- */
...
static void create() {
  ...
  SetKeyName("gold robe");
  SetId( ({ "robe" }) );
  SetShort("a gold robe");
  SetAdjectives( ({ "gold"}) );
  SetLong("The gold colored robe is nothing out of the ordinary, but it "
          "is a fairly well made article of clothing.  The robe is rather "
