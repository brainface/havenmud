...
// Filename: green_robe.c
// Author: Derek Noble
// Angel: dylanthalus@haven
// Creation Date: December 17th, 1998
// Abstract: just a standard green robe of not too much extravagence.
// Revision History: 
/* ----------------------------------------------------------------------- */
...
static void create() {
  ...
  SetKeyName("green robe");
  SetId( ({ "robe" }) );
  SetShort("a green robe");
  SetAdjectives( ({ "green"}) );
  SetLong("The green robe is nothing out of the ordinary, but it is "
